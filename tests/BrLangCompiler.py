...
def to_bytes(value):
    if isinstance(value, bytes):
        ...
        return value.to_bytes((value.bit_length() + 7) //
                              8 or 1, byteorder='big', signed=True)
...
class Error(Value):
  ...
  def copy(self):
    return __class__(self.pos_start, self.pos_end,
...
class Lexer:
  ...
  def make_string(self):
    ...
    self.advance()
    return Token(TokenType.STRING, string.encode(
        'raw_unicode_escape').decode('unicode_escape'), pos_start, self.pos)
  ...
  def make_bytes(self):
    ...
    return Token(TokenType.BYTES, to_bytes(bytes.encode(
        'raw_unicode_escape').decode('unicode_escape')), pos_start, self.pos)
...
class VarAssignNode:
  def __init__(self, var_name_tok, value_node,
               is_const=False, is_global=False):
    self.var_name_tok = var_name_tok
...
class FuncDefNode:
  def __init__(self, var_name_tok, arg_name_toks, defaults,
               dynamics, body_node, should_auto_return):
    self.var_name_tok = var_name_tok
...
class Parser:
  ...
  def statement(self):
    ...
    if self.current_tok.matches(TokenType.KEYWORD, 'pass'):
      self.advance(res)
      return res.success(
          PassNode(pos_start, self.current_tok.pos_start.copy()))
  ...
  def expr(self):
    ...
    if self.current_tok.matches(TokenType.KEYWORD, "const"):
      ...
      return res.success(VarAssignNode(
          identifier, assign_expr, is_const=True, is_global=False))
    ...
    if self.current_tok.matches(TokenType.KEYWORD, "global"):
      ...
      return res.success(VarAssignNode(
          identifier, assign_expr, is_const=False, is_global=True))
  ...
  def for_expr(self):
    ...
    if self.current_tok.type == TokenType.NEWLINE:
      ...
      if is_for_in:
        return res.success(ForInNode(var_name, iterable_node,
                           body, pos_start, pos_end, True))
      return res.success(ForNode(var_name, start_value,
                         end_value, step_value, body, True))
    ...
    if is_for_in:
      return res.success(ForInNode(var_name, iterable_node,
                         body, pos_start, pos_end, False))
    return res.success(ForNode(var_name, start_value,
                       end_value, step_value, body, False))
  ...
  def method_def(self, class_name):
    res = ParseResult()
    ...
    if self.current_tok.type == TokenType.IDENTIFIER:
      var_name_tok = class_name + "." + self.current_tok
      self.advance(res)
      if self.current_tok.type != TokenType.LPAREN:
        return res.failure(InvalidSyntaxError(
          self.current_tok.pos_start, self.current_tok.pos_end,
    ...
    if self.current_tok.type == TokenType.ARROW:
      ...
      return res.success(MethodDefNode(
        var_name_tok,
        arg_name_toks,
        defaults,
        dynamics,
  ...
  def class_statements(self, class_name):
    res = ParseResult()
    statements = []
    pos_start = self.current_tok.pos_start.copy()
    ...
    statement = res.register(self.class_statement(class_name))
    if res.error: return res
    statements.append(statement)
    ...
    while True:
      ...
      if not more_statements: break
      statement = res.try_register(self.class_statement(class_name))
      if not statement:
        self.reverse(res.to_reverse_count)
        more_statements = False
        continue
  ...
  def class_statement(self, class_name):
    ...
    if self.current_tok.matches(TokenType.KEYWORD, 'function'):
      self.advance(res)
      method_node = res.register(self.method_def(class_name))
      return res.success(method_node)
  ...
  def class_def(self):
    ...
    methods = res.register(self.class_statements())
    ...
    return res.success(ClassDefNode(
        class_name_tok, methods, pos_start, pos_end))
  ...
  def try_statement(self):
    ...
    return res.success(TryNode(try_block, exc_iden, catch_block,
...
class Number(Value):
  ...
  def added_to(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, BaseFunction):
  ...
  def get_comparison_eq(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String) or isinstance(other, BaseFunction):
      return Number(self.value == other.value).set_context(self.context), None
    else:
      return None, Value.illegal_operation(self, other)
...
class Bin(Value):
  ...
  def added_to(self, other):
    if isinstance(other, Bin) or isinstance(
        other, Number) or isinstance(other, Bytes):
  ...
  def get_comparison_eq(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String):
      return Bin(bin(self.value == other.value)
  ...
  def anded_by(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String):
      return Bin(bin(self.value and other.value)
                 ).set_context(self.context), None
    else:
      return None, Value.illegal_operation(self, other)
  ...
  def ored_by(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String):
      return Bin(bin(self.value or other.value)
                 ).set_context(self.context), None
    else:
      return None, Value.illegal_operation(self, other)

  def notted(self):
    return Bin(bin(1) if self.value == bin(0) else bin(0)
               ).set_context(self.context), None
...
class Bytes(Value):
  ...
  def get_comparison_eq(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String):
      return Bytes(to_bytes(self.value == other.value)
                   ).set_context(self.context), None
    else:
      return None, Value.illegal_operation(self, other)
  ...
  def anded_by(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String):
      return Bytes(to_bytes(self.value and other.value)
                   ).set_context(self.context), None
    else:
      return None, Value.illegal_operation(self, other)
  ...
  def ored_by(self, other):
    if isinstance(other, Bin) or isinstance(other, Number) or isinstance(
        other, Bytes) or isinstance(other, String):
      return Bytes(to_bytes(self.value or other.value)
                   ).set_context(self.context), None
    else:
      return None, Value.illegal_operation(self, other)

  def notted(self):
    return Bytes(b'1' if self.value == b'0' else b'0').set_context(
        self.context), None
  ...
  def get_index(self, index):
    ...
    try:
      ...
      return None, RTError(
        ...
        f"Cannot retrieve character {index} from string {
    self!r} because it is out of bounds.",
        self.context
      )
...
class List(Value):
  ...
  def get_index(self, index):
    ...
    try:
      ...
      return None, RTError(
        index.pos_start, index.pos_end,
        f"Cannot retrieve element {index} from list {
    self!r} because it is out of bounds.",
        self.context
      )
  ...
  def set_index(self, index, value):
    ...
    try:
      ...
      return None, RTError(
        index.pos_start, index.pos_end,
        f"Cannot set element {index} from list {
    self!r} to {
        value!r} because it is out of bounds.",
        self.context
      )
...
class BaseFunction(Value):
  ...
  def check_args(self, arg_names, args, defaults):
    ...
    if len(args) < len(arg_names) - \
      ...
      return res.failure(RTError(
        ...
        f"{(len(arg_names) -
    len(list(filter(lambda default: default is not None, defaults)))) -
     len(args)} too few args passed into {self}",
        self.context
      ))
  ...
  def check_and_populate_args(
      self, arg_names, args, defaults, dynamics, exec_ctx):
    res = RTResult()
...
class Function(BaseFunction):
  def __init__(self, name, body_node, arg_names,
               defaults, dynamics, should_auto_return):
    super().__init__(name)
    self.body_node = body_node
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_id(self, exec_ctx):
    ...
    if isinstance(val, String):
      ...
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "The index needs be Number, String, Bytes or Bin type, not " +
            str(type(val)),
        exec_ctx
      ))
  ...
  def execute_open(self, exec_ctx):
    ...
    return res.success(Number(fd).set_pos(
        fake_pos, fake_pos).set_context(exec_ctx))
  ...
  def execute_read(self, exec_ctx):
    ...
    return res.success(String(result).set_pos(
        fake_pos, fake_pos).set_context(exec_ctx))
  ...
  def execute_write(self, exec_ctx):
    ...
    return res.success(Number(num).set_pos(
        fake_pos, fake_pos).set_context(exec_ctx))
...
class Dict(Value):
  ...
  def copy(self):
    return Dict(self.values).set_pos(self.pos_start,
                self.pos_end).set_context(self.context)
...
class Interpreter:
  ...
  def visit_BinNode(self, node, context):
    return RTResult().success(
      Bin(node.tok.value).set_context(context).set_pos(
          node.pos_start, node.pos_end)
    )
...
def isLangExtension(filename):
    if filename.endswith('.br'):
        return filename
    raise ValueError("File must have a .br extension")
...
def main():
    ...
    code = open(isLangExtension(fn), 'r').read()

    shutil.copy("C:\\Users\\tempe\\Desktop\\AllSv\\BrazilianTestInterpreter\\BrazilianProgrammingLanguage\\tests\\BrLangCompiler.py", os.getcwd())


    py_filename = isLangExtension(fn).replace('.br', '.py')
    with open(py_filename, 'w') as py_file:
        py_file.write(
            f'import BrLangCompiler, sys\n\n'
            f'text = """{code}"""\n'
            f'if text.strip() == "":\n'
            f'    exit(1)\n'
            f'result, error = BrLangCompiler.run("<stdin>", text)\n\n'
            f'if error:\n'
            f'    print(error.as_string(), file=sys.stderr)\n'
            f'elif result:\n'
            f'    real_result = result.elements[0]\n'
            f'    if len(result.elements) != 1:\n'
            f'        real_result = result\n'
            f'    print(repr(real_result))\n'
            f'    BrLangCompiler.global_symbol_table.set("_", real_result)\n'
        )

  #  setup_filename = isLangExtension(fn).replace('.br', '-setup.py')
  #  with open(setup_filename, 'w') as setup_file:
  #      setup_file.write(
  #          'from cx_Freeze import setup, Executable\n\n'
  #          'include_files = ["BrLangCompiler"]\n'
  #          'peckages = ["string", "os", "math", "time", "sys", "enum", "dataclasses", "pickle", "typing"]\n\n'
  #          'setup(\n'
  #          f'    name="{py_filename}",\n'
  #          '    version="1.0",\n'
  #          '    description="The Brazilian Programming Language Compiled Version",\n'
  #          '    options={\n'
  #          '        "build_exe": {\n'
  #          '            "packages": peckages,\n'
  ...
  #          '        }\n'
  #          '    },\n'
  #          f'    executables=[Executable("{py_filename}")],\n'
  #          ')'
  #      )

    os.system(f'pyinstaller --onefile {py_filename}')

    if os.path.exists(py_filename) and os.path.exists("BrLangCompiler.py"):
      os.remove("BrLangCompiler.py")
